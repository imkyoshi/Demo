...
// Fetch the Controller and Model of User
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <img src="../../../public/img/icons/notification-bing.svg" alt="img"> <span class="badge rounded-pill">4</span>
            </a>
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <?php if (!empty($users)): ?>
                <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                    <span class="user-img">
                        <img src="<?php echo htmlspecialchars('../../../public/uploads/profiles/' . $users[0]['profile_image']); ?>" alt="Profile Image" width="40" height="40"> <!-- Display the profile image -->
                    ...
                    <div class="profilename">
                        <div class="profileset">
                            ...
                            <div class="profilesets">
                                    <h6><?php echo htmlspecialchars($users[0]['fullname']); ?></h6>
                                    <h5><?php echo htmlspecialchars($users[0]['role']); ?></h5>
                            </div>
                        </div>
                        <hr class="m-0">
                        ...
                        <hr class="m-0">
                        <a class="pb-0 dropdown-item logout" href="../auth/logout.php"><img src="../../../public/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
                    </div>
                </div>
            <?php endif; ?>
        </li>
